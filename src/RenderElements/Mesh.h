...
public:
    ...
    static std::shared_ptr<Mesh> CreatePlane(std::vector<Vertex> _planePoints, std::vector<Index> _planeIndicesPoints, std::shared_ptr<Material> _material, const bool _instance = false, std::string _customName = std::string());
